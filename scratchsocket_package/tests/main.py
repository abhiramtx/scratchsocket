...
class scratchlogin:
  ...
  class connect:
    def __init__(self, pid: int, maxVars=6):
      global ws
    ...
    def _respond(self, request_id, response, limit):
      ...
      while not remaining_response == "":
        if len(remaining_response) > limit:
          ...
          self.current_var += 1
          if self.current_var == self.maxVars:
            self.current_var = 1
          time.sleep(0.1)
        else:
        ...
        if not self.last_data == data:
          for activity in data:
            if activity['timestamp'] > self.last_timestamp and activity['name'] == "☁ TO_HOST":
              ...
              outp = f"{self._encode(length)}89{outp}"
...
class scratchsession:
  ...
  def _get_xtoken(self):
    try:
      ...
      print("Could not fetch your token, the requests may not always work.")
...
def ping():
  print("Ping recived.")
  return ["pong","pong","pong","pong","pong","pong","pong","pong","pong","pong","pong","pong","pong","pong","pong","pong","pong","pong","pong","pong","pong","pong","pong","pong","pong","pong","pong","pong","pong","pong","pong","pong","pong","pong","pong","pong","pong","pong","pong","pong","pong","pong","pong","pong","pong","pong","pong","pong","pong","pong","pong","pong","pong","pong","pong","pong","pong","pong","pong","pong","pong","pong","pong","pong","pong","pong","pong","pong","pong","pong","pong","pong","pong","pong","pong","pong","pong","pong","pong","pong","pong","pong","pong","pong","pong","pong","pong","pong","pong","pong","pong","pong","pong","pong","pong","pong","pong","pong","pong","pong","pong","pong","pong","pong","pong","pong","pong","pong","pong","pong"]
